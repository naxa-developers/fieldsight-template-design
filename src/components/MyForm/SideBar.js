                ...
                <Router>
                    ...
                    <div className="col-xl-3 col-lg-4">
                        <div className="left-sidebar new-sidebar sticky-top">
                            <div className="card no-boxshadow" style={{minHeight: this.props.height}}>
                    ...
                    <Switch>
                        <Route exact path='/' render={(props) => <MyFormContent {...props} 
                        title='MyFormContent' 
                       ...
                       <Route exact path='/projectform' render={(props) => <ProjectFormContent {...props} 
                        title='MyFormContent' 
                        OpenTabHandler={this.props.OpenTabHandler}
                        commonPopupHandler={this.props.commonPopupHandler}  />
